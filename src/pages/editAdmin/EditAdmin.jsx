...
const EditAdmin = () => {
  ...
  const {data, loading, error} = useFetch(`https://realstate-api-glm4.onrender.com/api/users/${adminId}`);
  ...
  const handleClick = async e => {
    ...
    try {
      ...
      await axios.put(`https://realstate-api-glm4.onrender.com/api/users/${adminId}`, newUser);
